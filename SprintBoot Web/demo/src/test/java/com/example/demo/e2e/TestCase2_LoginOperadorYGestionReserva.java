...
public class TestCase2_LoginOperadorYGestionReserva extends BaseTest {
    ...
    public void caso2_LoginOperadorGestionReservaYPago() throws InterruptedException {
        ...
        //2: Usuario ve sus reservas pendientes
        ...
        //3: Abrir nueva pestaña para operador
        ...
        // 9: Verificar total - buscar en el body
        Thread.sleep(2000);
        ...
        //14: Volver a pestaña del usuario y verificar
